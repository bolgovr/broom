...
(function () {
    ...
    a.detect = i(n), a.detectSeries = j(n), a.some = function (b, c, d) {
        ...
        var e = {}, h = [], i = function (a) {
            ...
            for (var b = 0; b < h.length; b += 1)if (h[b] === a) {
                h.splice(b, 1);
                return
            }
        }, k = function () {
        ...
        i(function () {
            g(e).length === c.length && b(null, e)
        }), d(c, function (c) {
            var d = a[c]instanceof Function ? [a[c]] : a[c], g = function (a) {
                if (a)b(a), b = function () {
                }; else {
                    var d = Array.prototype.slice.call(arguments, 1);
                    d.length <= 1 && (d = d[0]), e[c] = d, k()
                }
            }, h = d.slice(0, Math.abs(d.length - 1)) || [], l = function () {
                return f(h, function (a, b) {
                    return a && e.hasOwnProperty(b)
                }, !0)
            };
            if (l())d[d.length - 1](g, e); else {
                var m = function () {
        ...
        var d = function (b) {
            return function (e) {
                if (e)c(e), c = function () {
                    ...
                    var f = Array.prototype.slice.call(arguments, 1), g = b.next();
    ...
    a.concat = i(o), a.concatSeries = j(o), a.whilst = function (b, c, d) {
        ...
        var d = 0, e = {tasks:[], concurrency:c, saturated:null, empty:null, drain:null, push:function (b, d) {
            e.tasks.push({data:b, callback:d}), e.saturated && e.tasks.length == c && e.saturated(), a.nextTick(e.process)
        }, process:function () {
            if (d < e.concurrency && e.tasks.length) {
                var a = e.tasks.shift();
                e.empty && e.tasks.length == 0 && e.empty(), d += 1, b(a.data, function () {
                    d -= 1, a.callback && a.callback.apply(a, arguments), e.drain && e.tasks.length + d == 0 && e.drain(), e.process()
                })
            }
        }, length:function () {
    ...
    a.log = p("log"), a.dir = p("dir"), a.memoize = function (a, b) {
        ...
        var e = function () {
            var e = Array.prototype.slice.call(arguments), f = e.pop(), g = b.apply(null, e);
